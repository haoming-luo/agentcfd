...
27. For one-inlet/one-outlet imported equipment, preserve the generated
    ...
    Read `agentcfd observations . --json`, `step.observation_catalog()`, or the
    copy embedded in `plan --json` before inventing post-processing: they
    resolve shared targets and explicitly mark compact reports as independent
    from full-field frames.
